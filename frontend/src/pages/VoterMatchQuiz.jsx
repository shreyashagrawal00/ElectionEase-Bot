    ...
    if (step === 'calculating') {
        return (
            <div className="max-w-4xl mx-auto py-32 px-4 text-center">
                ...
                >
                    <div className="w-24 h-24 bg-primary-50 rounded-full flex items-center justify-center mx-auto mb-8 animate-bounce">
                        <Target className="w-12 h-12 text-primary-600" />
                    </div>
                    <h2 className="text-3xl font-black text-slate-900 mb-2">{t('quiz.match_calc')}</h2>
                    <div className="w-48 h-2 bg-slate-100 rounded-full mx-auto overflow-hidden mt-8">
                        <motion.div 
                            initial={{ x: '-100%' }}
                            animate={{ x: '100%' }}
        ...
        return (
            <div className="max-w-4xl mx-auto py-32 px-4 text-center">
                <motion.div 
                    ...
                    className="p-16 glass-card rounded-[4rem] shadow-3xl bg-slate-900 text-white border-slate-800"
                >
            ...
            <div className="relative">
                ...
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        exit={{ x: -50, opacity: 0 }}
                        className="glass-card p-12 rounded-[3.5rem] shadow-2xl border-white/50 bg-white/60"
                    >
                        ...
                        <div className="grid gap-4">
                            {q.options.map((opt, i) => (
                                <button
                                    ...
                                    className="p-6 rounded-2xl border-2 border-slate-100 text-left hover:border-primary-500 hover:bg-primary-50/50 hover:shadow-lg transition-all group flex items-center justify-between"
                                >
                                    <span className="font-bold text-slate-700 group-hover:text-primary-700">{opt}</span>
