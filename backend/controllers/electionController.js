    ...
    const seedData = [
      {
        title: { 
          ...
          te: 'మహారాష్ట్ర రాష్ట్ర అసెంబ్లీ ఎన్నికలు 2026',
          ml: 'മഹാരാഷ്ട്ര നിയമസഭാ തിരഞ്ഞെടുപ്പ് 2026',
          kn: 'ಮಹಾರಾಷ್ಟ್ರ ವಿಧಾನಸಭಾ ಚುನಾವಣೆ 2026'
        },
        ...
        steps: [
          { 
            ...
            description: { 
              ...
              kn: 'ಮತದಾರರ ಪಟ್ಟಿಯಲ್ಲಿ ನಿಮ್ಮ ಹೆಸರಿರುವುದನ್ನು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ.'
            }, 
            order: 1, 
          ...
          { 
            title: { 
              ...
              gu: 'ઉમેદવાર નામાંકન', bn: 'প্রার্থী মনোনয়ন', ta: 'வேட்பாளர் நியமனம்', te: 'అభ్యర్థి నామినేషన్',
        ...
        candidates: [
          { 
            ...
            bio: { 
              ...
              mr: 'સ્થાનિક સમુદાય નેતા અને સામાજિક કાર્યકર.',
